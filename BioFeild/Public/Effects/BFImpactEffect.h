...
/**
* used for simulate some particles and sound effects when impact hit events generated,
* different surface type will cause different impact effects;
*/
...
UCLASS()
class BIOFEILD_API ABFImpactEffect : public AActor
{
...
public:
	UParticleSystem*  GetImpactParticlesBySurfaceType(EPhysicalSurface SurfaceType);

	USoundCue* GetImpactSoundBySurfaceType(EPhysicalSurface SurfaceType);

	UMaterial* GetDecalMaterialBySurfaceType(EPhysicalSurface surfaceType);
};
